...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| ------------ |
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.    | Acha Esquerre, Stevens Kharis<br> TB1 <br>Logré comunicar oralmente mis ideas a mi equipo por medio de reuniones para el desarrolo del proyecto. Asimismo, pude expresar los resultados del proyecto por medio de un video expositivo, explicando el capítulo 4, correspondiente al diseño UI/UX y Domain-Drive Software Architecture. <br>TP<br> Logré comunicar mis ideas y resultados orálmente a través de las reuniones en equipo y el video expositivo, explicando mi parte del Sprint 2, la Entidad Chapters con su CRUD. Asimismo por medio de la exposición realizada en clase.<br> TB2 <br> Logré comunicar mis ideas y resultados orálmente a través de las reuniones por medio de WhatsApp y Discord con el equipo, además de por medio del video expositivo donde expliqué mi aporte para este Sprint 3, abarcando la entidad Chapters para el Backend, y mostrando mejora continua con el progreso del Frontend.<br> TF<br> Logré comunicar mis ideas oralmente a través de las reuniones en equipo para solucionar conflictos encontrados en el software. Asimismo, comuniqué mis resultados dentro de lo posible por medio del video expositivo y la exposición en clase. <br> Laguerre Challco, Fabrizzio Hernán <br> TB1 <br>Logré comunicar oralmente mis ideas a mi equipo por medio de reuniones para el desarrolo del proyecto. Asimismo, pude expresar los resultados del proyecto por medio de un video expositivo. <br>TP<br> Logré comunicar oralmente mis ideas a mis compañeros a través de las reuniones virtuales y las presentaciones en clase. <br> TF <br> Logré expresar verbalmente mis ideas en las reuniones de equipo para abordar y resolver los conflictos detectados en el software. También, en la medida de lo posible, compartí mis resultados mediante un video expositivo y presentaciones en clase. <br> <br>Patazca Calderón, Santos Alexis <br> TB1 <br> Mantuve la comunicación con mis compañeros de equipo a través de las diversas reuniones con el fin de lograr un trabajo eficiente. Se concretaron varias ideas y se logro ir avanzando. Pude despejar mis diversas dudas gracias a mis compañeros. <br> TP <br> Conseguí plasmar mis ideas en el proyecto que se había asignado previamente a las reuniones con mis compañeros, realizando un CRUD que fue explicando mediante un video. <br> TB2 <br>  En este entregable pude realizar la entidad de Fanfic para el Backend y comunique a mis compañeros sobre los cambios y poder pedir ayuda cuando era necesario, propuse mis ideas. <br> TF<br>  Para este nuevo entregable pude compartir mis ideas a mis compañeros a traves de reuniones y tambien pedir ayuda cuando habia inconvenientes en el backend, termine realizando mi aporte en este proyecto.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |              |
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería. | Acha Esquerre, Stevens Kharis<br> TB1 <br>Logré comunicar de manera escrita mis ideas a mi equipo por medio de reuniones para el desarrollo del proyecto. Pude expresar mis resultados encargándome del capitulo 4, tanto dentro de los MockUps como en el approach de Domai-Driven Software Architecture. <br>TP<br> Logré comunicar mis ideas y resultados de manera escrita a través de las reuniones en equipo, la mejora continua del reporte, y el desarrollo del CRUD de la entidad Chapters para la primera versión de la aplicación frontend. <br> TB2 <br> Logré comunicar mis ideas y resultados de manera escrita a través de las reuniones en equipo, además de por medio del reporte y en mi aporte para este Sprint 3, abarcando la entidad Chapters para el Backend, y mostrando mejora continua con el progreso del código del Frontend. <br> TF <br> Logré comunicar mis resultados de manera escrita por medio de la realización de código y mi aporte dentro del proyecto de manera continua, tanto implementando nueva funcionalidad, como corrigiendo errores. Asimismo, logré comunicar mis ideas de manera escrita por medio del grupo formado en redes sociales, de forma que contribuí en la organización y en la toma de decisiones para el desarrollo del proyecto. <br> <br> Laguerre Challco, Fabrizzio Hernán <br> TB1 <br>Logré comunicar de manera escrita mis ideas a mi equipo por medio de reuniones para el desarrolo del proyecto. Asimismo, pude expresar los resultados del proyecto por medio del reporte realizado. <br>TP<br> Logré comunicar de manera escrita mis ideas a mis compañeros a través de las reuniones virtuales y mi parte dentro del avance del frontend.<br> TF <br>  Logré Transmitir mis logros mediante la elaboración de código y mi constante contribución al proyecto, abordando tanto la introducción de nuevas funcionalidades como la corrección de errores. Además, conseguí expresar mis ideas por escrito a través del grupo creado en redes sociales brindando apoyo y documentación al código. <br> <br> Patazca Calderón, Santos Alexis <br> TB1 <br> Logre finalizar con éxito el trabajo propuesto, que se me había asignado el capitulo 2 que fue de gran importancia para conocer a nuestro publico objetivo realizando entrevistas y conocer las diversas propuestas que tienen nuestros competidores. <br> TP <br> Se realizó las correcciones del entregable anterior, como es el caso del reporte que facilita una mejor lectura de nuestro proyecto. Desarrollé un CRUD que es una primera versión y muestra el registro, editar y eliminar los fanfics.  <br> TB2 <br> Comunique mis ideas a traves del chat gruapl para poder resivir una retroalimentacion or parte de mis compañeros y poder terminar con exito la entidad. <br> TF <br> En esta oportunidad pude avanzar parte del frontend entregando mi parte que me fue asignada y comunicando a mis compñaeros para lograr culminar, tambien avance con mi entiedad. <br> <br> Zegarra Moreno, Salomón<br>TB1<br> A través del reporte del trabajo final pude comunicar mis ideas, colaboré en el desarrollo de la estructura del informe y de las partes que en reuniones habíamos quedado para resolver.<br> TP1<br> Para este entregable desarrolle la estructura del informe<br> TB3<br> Para este entregable desarrolle la estructura del informe y se añadió la entidad category |              |

---

# Project Report Collaboration Insights

[Repository to Final Report](https://github.com/Programadores-de-lavadoras/Report) <br>
[Frontend Repository](https://github.com/Programadores-de-lavadoras/front-ficuniverse)<br>
[Backend Repository](https://github.com/Programadores-de-lavadoras/back-ficuniverse)<br>
[Landing page Repository](https://github.com/Programadores-de-lavadoras/PDL-landing-page)<br>
[Team Organization](https://github.com/Programadores-de-lavadoras)
...
- [Capítulo V: Product Implementation, Validation, & Deployment](#capítulo-v-product-implementation-validation--deployment)
  ...
  - [Landing Page, Services & Applications Implementation](#52-landing-page-services--applications-implementation)
    ...
    - [Sprint 2](#531-sprint-2)
      - [Sprint Planning](#5311-sprint-planning-2)
      - [Sprint Backlog 2](#5312-sprint-backlog-2)
      - [Development Evidence for Sprint Review](#5313-development-evidence-for-sprint-review)
      - [Testing suite evidence for Sprint Review](#5314-testing-suite-evidence-for-sprint-review)
      - [Execution Evidence for Sprint Review](#5315-execution-evidence-for-sprint-review)
    ...
    - [Sprint 4](#524-sprint-4)
      - [Sprint Planning 4](#5241-sprint-planning-4)
      - [Sprint Backlog 4](#5242-sprint-backlog-4)
      - [Development Evidence for Sprint Review](#5243development-evidence-for-sprint-review)
      - [Testing suite evidence for Sprint Review](#5244testing-suite-evidence-for-sprint-review)
      - [Execution Evidence for Sprint Review](#5245execution-evidence-for-sprint-review)
      - [Services Documentation Evidence for Sprint Review](#5246services-documentation-evidence-for-sprint-review)
      - [Software Deployment for Sprint Review](#5247software-deployment-evidence-for-sprint-review)
      - [Team Collaboration Insights during Sprint](#5248team-collaboration-insights-during-sprint)
...
Para el formato de versiones se aplicará “Semantic Versioning 2.0.0”. Dónde las versiones siguen el formato de (X.Y.Z).
En dónde:
...
| **Sprint Planning Background**   |                                                                                                                                   |
| -------------------------------- |-----------------------------------------------------------------------------------------------------------------------------------|
| **Date**                         | *01 de noviembre del 2023**                                                                                                       |
| Time                             | 15:00 horas (GMT-5)                                                                                                               |
| **Location**                     | **Modalidad remota por Discord**                                                                                                  |
| Prepared By                      | Salomón Zegarra                                                                                                                   |
| Attendees (to plannign meeting)  | Todos los miembros del equipo FicUniverse                                                                                         |
| Sprint n-1 Review summary        | Se realizó un avance del backend, y se arregló el reporte final. Por otro lado se terminaron las secciones que faltaban del front |
| Sprint n-1 Retrospective Summary | La implementación del backend se ha realizado empleando Spring Boot, lo que resultó algo nuevo para algunos miembros del equipo.  |
| Sprint Goal & User Stories       | Se realizarán los primeros bounded context de nuestro backend empleando Spring Boot como framework.                               |
| Sprint 2 Velocity                | 2 semanas                                                                                                                         |
| Sum of Story Points              | 25                                                                                                                                |
...
![Team collaboration evidence 1](team-collaboration-sprint4-1.png)

![Team collaboration evidence 2](team-collaboration-sprint4-2.png)
